...
const projects = [
  {
    id: 1,
    title: "Videoclip Musical - Artista Internacional",
    description: "Producción audiovisual completa para uno de los artistas más reconocidos de la región",
    image: musicImage,
    category: "Música",
    year: "2024"
  },
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-4">
            Proyectos <span className="bg-gradient-accent bg-clip-text text-transparent">Destacados</span>
          </h2>
